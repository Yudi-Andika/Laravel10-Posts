                                ...
                                <table class="min-w-full divide-y divide-slate-950 ">
                                    <thead class="bg-gray-100">
                                        <tr class="divide-x divide-slate-950">
                                            <th scope="col" class="px-6 py-3 text-center text-xs font-semibold text-gray-800 uppercase">Gambar</th>
                                            <th scope="col" class="px-6 py-3 text-center text-xs font-semibold text-gray-800 uppercase">Judul</th>
                                            <th scope="col" class="px-6 py-3 text-center text-xs font-semibold text-gray-800 uppercase">Content</th>
                                    ...
                                    <tbody class="divide-y  border-slate-950  divide-slate-950">
                                        ...
                                        <tr class="divide-x divide-slate-950">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-center  text-sm text-gray-800 ">{{ $post->title }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-center  text-sm text-gray-800 ">{!! $post->content !!}</td>
